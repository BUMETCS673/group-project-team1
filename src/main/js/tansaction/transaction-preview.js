        ...
        <Container
            ...
            <Table striped bordered hover>
                ...
                {props.transactions.map((item) => (
                    <tr key={item.id}>
                        <td valign={"middle"} align={"center"}>{item.time}</td>
                        <td valign={"middle"} align={"center"}>{item.counterparty}</td>
                        <td valign={"middle"} align={"center"}>{item.transactionDescription}</td>
                        <td valign={"middle"} align={"center"}>${item.money}</td>
